...
let userID = '856b1a66-3226-1c65-a3f4-c7c6dbaa2555';
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					case `/bestip/${userID_Path}`: {
						...
						const url = `https://sub.zsfan.us.kg/auto?host=${request.headers.get('Host')}&uuid=${userID}&path=/`;
...
---------------------------------------------------------------`;
	...
	const header = `
<p align='center'><img src='https://telegram-5yk.pages.dev/file/7a9ccd2554c182d659c13.jpg' alt='图片描述' style='margin-bottom: -50px;'>
...
<a href='https://github.com/Zsfan1224/Cloudflare-Pages-Proxy' target='_blank'>Cloudflare-Pages-Proxy- https://github.com/Zsfan1224/Cloudflare-Pages-Proxy</a>
